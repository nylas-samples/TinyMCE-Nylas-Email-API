...
```yaml
# Nylas application keys - see [https://developer.nylas.com/docs/developer-guide/authentication/authorizing-api-requests/#sdk-authentication](https://developer.nylas.com/docs/v3/auth/hosted-oauth-apikey/#start-an-authorization-request)
